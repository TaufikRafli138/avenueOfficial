...
export default function ChatItem({ data, onDelete, onApproval }) {
    ...
    return (
        <div className="border rounded-2xl p-4 shadow mb-2 bg-white">
            <div className="text-sm text-gray-500 mb-3">
                <b>{data.Nama}</b> Ngirimin Surat Ke Member Nih. Suratnya ditujukan untuk {data.Member}. Yuk Kepoin Suratnya.
            </div>
