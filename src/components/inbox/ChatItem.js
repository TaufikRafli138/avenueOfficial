...
export default function ChatItem({ data, onReply, onDetailContact }) {
    ...
    const buttonStyle1 = {
        padding: '4px 12px',
        fontSize: '0.875rem',
        backgroundColor: isHover1 ? '#ffffff' : '#7e22ce',
        color: isHover1 ? '#7e22ce' : '#ffffff',
        border: '1px solid #7e22ce',
        borderRadius: '6px',
        cursor: 'pointer',
        transition: 'all 0.2s ease-in-out',
    ...
    return (
        <div className="border rounded-2xl p-4 shadow mb-2 bg-white">
            <div className="text-sm text-gray-500 mb-3">
                <b>{data.Name}</b> Ngirimin kamu Surat Nih. Kepada Para Staff Mohon di cek ya isi suratnya. Siapa tau Cuan. Terima Kasih..
            </div>
